...
exports.run = async (bot, msg, args) => {
        ...
        userinfo.bot = user.bot.toString()///discord.gg/qGWXFs8
        .replace("false", `Hayır`)
        .replace("true", `Evet`)
        ...
        .replace("Friday", `**Cuma**`)
        .replace("Saturday", `**Cumartesi**`)///discord.gg/qGWXFs8
        ...
        .replace("July", `**Temmuz**`)///discord.gg/qGWXFs8
        ...
        .replace("January", `**Ocak**`)
        .replace("February", `**Şubat**`)
        .replace("March", `**Mart**`)///discord.gg/qGWXFs8
        .replace("April", `**Nisan**`)
        .replace("May", `**Mayıs**`)
        .replace("June", `**Haziran**`)
        .replace("July", `**Temmuz**`)
        ...
        .replace("October", `**Ekim**`)
        .replace("November", `**Kasım**`)
        .replace("December", `**Aralık**`)///discord.gg/qGWXFs8
        ...
        .addField(`Kimlik:`, userinfo.id, true)///discord.gg/qGWXFs8
